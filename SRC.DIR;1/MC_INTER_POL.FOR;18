     ...
     *                      ftranse,delole,avrefe,upx,dwx)
 
        IMPLICIT REAL (A-H,O-Z)
        REAL G05CBF, G05CCF, G05DAF

C Extra definitions for VAX
...
CCC	integer startup, startdw
	...
	REAL SPINUP_WTX, SPINDW_WTX, SPINUP_WTS, SPINDW_WTS 
	...
	real  upx(100), dwx(100), ups(100), dws(100)
...
* Spin "Up"
	SPINUP = SPINUP + 1
	SPINUP_WTX = SPINUP_WTX + WT
	ELSE
* Spin "Down"
	SPINDW = SPINDW + 1
	SPINDW_WTX = SPINDW_WTX + WT
*	print*,'spin is -ve'
	ENDIF
...
*        PRINT*,'NO. ABSORBED =',NABSORB
	...
	AVREF = WNREFT/WGX
        ...
        SPINUP_WTX = SPINUP_WTX / nhist
        SPINDW_WTX = SPINDW_WTX / nhist
...
*  	Calculation of elapsed time etc... for VAX
	...
	SPINUP_WTX = SPINUP_WTX *1.E+06
	SPINDW_WTX = SPINDW_WTX *1.E+06

	SPINUP_WTS = SPINUP_WTS *1.E+06
	SPINDW_WTS = SPINDW_WTS *1.E+06
